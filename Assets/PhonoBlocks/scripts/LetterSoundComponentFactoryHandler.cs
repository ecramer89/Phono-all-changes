...
public class LetterSoundComponentFactoryManager 
{
		...
		public abstract class LetterSoundComponentFactory 
		{
		...
		public class SyllableFactory : LetterSoundComponentFactory
		{
				...
				public override UserWord Parse (string word, bool bySyllables=false)
				{
			            ...
			            //todo ned to change- need some sort of intermediary to set the colors.
			           //maybe just the color coding scheme.
						userWord.ApplyColoursToLetterSoundComponents (); 
